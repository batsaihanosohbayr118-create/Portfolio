...
const Hero = ({darkMode}) => {
    const socialIcons = [
        {icon: Instagram, alt: 'Instagram', link: 'https://www.instagram.com/Б.Өсөхбаяр'},
        {icon: tiktok, alt: 'tiktok', link: 'https://www.tiktok.com/osgoo-b'},
        {icon: github, alt: 'github', link: 'https://github.com/batsaihanosohbayr118-create'},
        {icon: facebook, alt: 'facebook',  link: 'https://www.facebook.com/Б.Өсөхбаяр'}
    ];
    ...
    const lightTheme = {
      ...
      buttonSecondary: 'text-grey-800 border-2 border-orange-500 hover:bg-orange-500 hover:text-white',
      ...
      className='body-font z-10'>
        ...
        lg:mt-0 mt-14'>
          ...
          lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
            ...
            data-aos='fade-up'
            data-aos-delay='600'> My name is Osokhbayr.
               ...
               <div className='w-full pt-4 sm:pt-6'>
                ...
                >
                  ...
                  <a href="#contact" className='w-full sm:w-auto'>
                    ...
                    justify-center text-orange-600 border-0
                    py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)]
                    rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform`}>
          ...
          data-aos-delay='400'>
            ...
            <div className='relative overflow-hidden'>
              ...
              className='w-120 h-120 rounded-full object-cover transform hover:scale-105 transition-transform duration-500' />
            </div>
        ...
        <div className={`absolute -top-20 -left-20 w-40 h-40 sm:w-64 sm:h-64 ${theme.decorativeCircle} rounded-full
