      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        <article className="text-center lg:text-left relative order-1 lg:order-2">
          ...
          >
            ...
            individual who values discipline and continuous self-development. 
            I'm punctual, detail-oriented, and committed to delivering high-quality work. 
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
            <div className="text-center" data-aos="zoom-in" data-aos-delay="600">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange-400">
                {animate && <CountUp start={0} end={3} duration={2} />}+
              </div>
              <div className={darkMode ? 'text-gray-300' : 'text-gray-600'}>Education</div>
            </div>

            <div className="text-center" data-aos="zoom-in" data-aos-delay="600">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange-400">
                {animate && <CountUp start={0} end={5} duration={2.5} />}+
              </div>
              <div className={darkMode ? 'text-gray-300' : 'text-gray-600'}>My Skills</div>
            </div>

            <div className="text-center" data-aos="zoom-in" data-aos-delay="600">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange-400">
                {animate && <CountUp start={0} end={10} duration={3} />}+
              </div>
              <div className={darkMode ? 'text-gray-300' : 'text-gray-600'}>Projects</div>
            </div>
          </div>

          {/* BUTTON */}
          <button
            className={`w-full sm:w-auto border-2 border-orange-500 inline-flex items-center justify-center text-orange-600 py-2 px-4 sm:px-6 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform ${
