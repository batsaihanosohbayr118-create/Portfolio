...
import { FaGithub, FaExternalLinkAlt, FaHeart, FaRegHeart, FaChevronDown, FaChevronUp } from "react-icons/fa";
        ...
        {filteredProjects.length > 3 && (
          ...
          >
            <motion.button
              ...
              className={`flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-3 rounded-full font-bold shadow-lg border-2 border-orange-500 transition-all
