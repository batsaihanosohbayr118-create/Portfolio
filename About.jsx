      ...
      >
        ...
        className='text-center lg:text-left relative order-1 lg:order-2'>
          <header>
            ...
            font-bold mb-4 sm:mb-6 text-transparent bg-linear-to-r from-orange-400
          ...
          mb-6 sm:mb-8 leading-relaxed bg-linear-to-r from-orange-900/10
          to-orange-900/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl backdrop-blur-sm
          ...
          data-aos-delay='500'>
            ...
            I'm a punctual, detail-oriented, and committed to delivering 
            high-quality work. I'm always eager to learn new skills and take on 
            new challenges in order to create long-term value. 
          </p>
